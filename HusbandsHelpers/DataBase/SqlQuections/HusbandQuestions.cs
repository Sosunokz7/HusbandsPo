...
{
	class HusbandQuestions : AbstractQustion, IQustion<HusbandsProperty>
	{
		public async Task<int> GetQustion(string question, BindingList<HusbandsProperty> ls)
		{
